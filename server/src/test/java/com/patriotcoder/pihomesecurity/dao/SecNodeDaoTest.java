...
public class SecNodeDaoTest extends AbstractCassandraDockerParameterizedTest {
  ...
  /**
   * Constructor. The file parameter is provided by the parameterized tests (defined by
   * generateParameters in the parent class).
   *
   * @param dockerFile Parameter for this test. It's the docker file that represents the version of
   *        Cassandra we are testing.
   */
