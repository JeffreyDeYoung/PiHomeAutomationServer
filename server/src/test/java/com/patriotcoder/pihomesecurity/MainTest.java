...
public class MainTest extends TestCase {
  ...
  public void testSetUpDocussandra() throws Exception {
    ...
    assertTrue(indexDao.exists(new IndexIdentifier(Constants.DB, Constants.NODES_TABLE,
        Constants.NODES_TABLE_NAME_INDEX)));
    assertTrue(indexDao.exists(new IndexIdentifier(Constants.DB, Constants.NODES_TABLE,
        Constants.NODES_TABLE_RUNNING_INDEX)));
    assertTrue(indexDao.exists(new IndexIdentifier(Constants.DB,
        Constants.ACTOR_ABILITY_STATUS_TABLE, Constants.ACTOR_ABILITY_STATUS_NAME_INDEX)));
