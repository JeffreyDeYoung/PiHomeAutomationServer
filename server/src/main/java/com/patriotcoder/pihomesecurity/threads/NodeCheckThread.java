...
/**
 * Thread that constantly checks (via ping) to confirm that the Pi (or other mircocomputer) has not
 * gone off line (ie, make sure someone hasn't unplugged it to disable it as a security device.)
 *
