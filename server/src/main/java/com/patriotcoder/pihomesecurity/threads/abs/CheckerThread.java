...
/**
 * Abstract Thread that checks the state of a child class and triggers an action if needed.
 *
...
public abstract class CheckerThread extends Thread {
   ...
   * @param failuresBeforeTrigger Number of times a check will fail before it triggers.
   */
  ...
  /**
   * Trigger response to a sensor that was previously failed, but is now passing.
   */
   ...
   *
   * @return Human readable (preferably unique) string describing this test briefly.
   */
