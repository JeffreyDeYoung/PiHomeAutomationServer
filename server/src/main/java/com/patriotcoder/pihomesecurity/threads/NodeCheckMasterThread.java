...
/**
 * Thread that constantly checks (via ping) to confirm that the nodes have not gone off line (ie,
 * make sure someone hasn't unplugged one/all of them to disable them as a security device.)
 *
...
public class NodeCheckMasterThread extends CheckerThread {
  ...
  /**
   * Docussandra QueryDao -- used to check to see which nodes are currently registered.
   */
  ...
  /**
   * Builder method for this singleton class. Use if you want to get an instance of this class. (May
   * return a new or existing object.)
   *
  ...
  public void triggerSensorProblem() {
    String message =
        "Could not connect to Docussandra to get currently registered nodes!: " + docussandraUrl;
    logger.info(message);
